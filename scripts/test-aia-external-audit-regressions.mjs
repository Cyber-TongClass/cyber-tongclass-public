...
test("academic exchange applications expose a complete reviewer and withdrawal workflow", () => {
  ...
  const studentDetail = read("src/app/tong-class/intranet/reimbursements/academic-exchange/[id]/page.tsx")
  ...
  assert.match(studentDetail, /\/edit/)
  assert.ok(fs.existsSync(path.join(root, "src/app/tong-class/intranet/reimbursements/academic-exchange/[id]/edit/page.tsx")))
  assert.match(read("src/app/tong-class/intranet/reimbursements/academic-exchange/new/page.tsx"), /localStorage/)
