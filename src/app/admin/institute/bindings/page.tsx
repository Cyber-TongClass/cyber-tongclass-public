    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
          仅通过精确主站账号 ID 建立目录归属。绑定教师后，公开 Coffee Talk 入口才会启用；教师 Reviewer 授权仍保留独立 Reviewer 账号与凭据。
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm leading-6 text-slate-600">一个主站账号最多绑定一位研究院目录人员。未绑定的教师不会开放 Coffee Talk。</p>
