...
const submissionItems = [
  ...
  "算力使用说明报告。如使用学院或组委会统一提供的算力资源，则须提交该报告。",
]
    ...
    <div className="min-h-screen bg-[hsl(211,30%,97%)]">
      ...
      <main className="mx-auto max-w-6xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <SectionCard title="参赛人员" icon={<Users className="h-5 w-5 text-primary" />}>
          ...
          <p>
            本次比赛经历可作为后续发展材料的一部分。新大一学生可用于体现 AI 兴趣基础、实践能力和集体参与意识；通班在读本科生可作为奖学金申请中“社会工作”或相关实践经历部分的支撑材料，具体认定以通班及学院后续实际要求为准。
          </p>
        </SectionCard>
        ...
        <SectionCard title="作品方向" icon={<Code2 className="h-5 w-5 text-primary" />}>
          ...
          <p>
            两个赛道分别组织评审、分别设置奖项，暂定奖金额度分配为 1:1。参赛同学可根据项目需要进行模型训练或专用大模型微调；学院将为符合条件的项目提供免费算力支持。
          </p>
        </SectionCard>
