      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent className="grid gap-3">
            ...
            <Field label="论文 PDF 链接" value={<a href={application.paperPdfUrl} target="_blank" rel="noreferrer" className="text-primary hover:underline">{application.paperPdfUrl}</a>} />
          </CardContent>
        </Card>
