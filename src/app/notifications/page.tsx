    ...
    <div className="min-h-screen bg-slate-50 px-4 py-12 sm:py-16">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mt-6" aria-labelledby="aia-notifications-heading">
          ...
          <h1 id="aia-notifications-heading" className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">通知</h1>
          <p className="mt-3 leading-7 text-slate-600">当前仅显示与本账户相关的通用服务状态通知。</p>
