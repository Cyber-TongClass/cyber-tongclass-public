    ...
    return [...newsItems]
      ...
      .map((item) => {
        ...
        return {
          ...
          href: shouldOpenOriginalDirectly ? item.sourceUrl! : `/tong-class/news/${item._id}`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-6 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button asChild size="lg" className="gap-2">
                <Link href="/tong-class/about">
                  了解更多 <ArrowRight className="h-4 w-4" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg">
                <Link href="/tong-class/members">查看成员</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom relative z-10">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                {newsItems
                  ...
                  .map((item) => (
                    <Link
                      key={item._id}
                      href={item.sourceUrl || `/tong-class/news/${item._id}`}
              ...
              <Link href="/tong-class/news" className="block mt-2 bg-white shadow-sm hover:bg-slate-50 transition-colors duration-200 text-center py-2.5">
            ...
            <div>
              ...
              <div className="space-y-2">
                {publications
                  ...
                  .slice(0, 4)
                  .map((pub) => (
                    <Link key={pub._id} href={`/tong-class/publications/${pub._id}`}>
                      <div className="group bg-white px-4 py-3 shadow-sm hover:bg-slate-50 transition-colors duration-200">
                        <div className="flex items-center gap-2 mb-1">
              ...
              <Link href="/tong-class/publications" className="block mt-2 bg-white shadow-sm hover:bg-slate-50 transition-colors duration-200 text-center py-2.5">
