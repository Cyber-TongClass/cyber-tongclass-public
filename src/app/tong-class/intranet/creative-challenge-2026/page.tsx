            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild variant="outline">
                  <Link href="/tong-class/intranet/creative-challenge-2026/rules">
                ...
                {canRegister ? (
                  <>
                    ...
                    <Button asChild variant="outline">
                      <Link href="/tong-class/intranet/creative-challenge-2026/projects">
                        ...
                        {!item.finalSubmittedAt ? (
                          <>
                            ...
                            <Button asChild size="sm" variant="outline">
                              <Link href={`/tong-class/intranet/creative-challenge-2026/projects?project=${encodeURIComponent(item.id)}`}>
                                <FileCheck2 className="mr-2 h-4 w-4" />
                                编辑和提交
                              </Link>
                            </Button>
