...
const staticModules = [
  {
    ...
    href: "/tong-class/intranet/reimbursements/academic-exchange",
    icon: FileText,
  },
]
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-primary relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 relative">
          ...
          <Link href="/tong-class/intranet" className="inline-flex items-center gap-1 text-sm text-white/60 hover:text-white mb-4 transition-colors">
      ...
      <section className="bg-[hsl(211,30%,97%)] py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-4 md:grid-cols-2">
          ...
          {reimbursementForms?.map((form) => (
            <Link key={form._id} href={`/tong-class/intranet/forms/${form.slug}`} className="block h-full">
              <Card className="h-full transition-all hover:-translate-y-0.5 hover:shadow-md">
                <CardHeader>
