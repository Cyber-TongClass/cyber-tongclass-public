      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <Tabs defaultValue="introduction" className="w-full">
          <TabsList className="flex w-full border-b border-slate-200 bg-transparent h-auto p-0">
            <TabsTrigger value="introduction" className="flex-1 py-3 data-[state=active]:shadow-[inset_0_-2px_0_0_hsl(var(--primary))] data-[state=active]:text-primary text-slate-500 hover:text-slate-900 rounded-none bg-transparent font-medium text-sm transition-colors text-center">项目介绍</TabsTrigger>
            <TabsTrigger value="accounts" className="flex-1 py-3 data-[state=active]:shadow-[inset_0_-2px_0_0_hsl(var(--primary))] data-[state=active]:text-primary text-slate-500 hover:text-slate-900 rounded-none bg-transparent font-medium text-sm transition-colors text-center">官方账号</TabsTrigger>
            <TabsTrigger value="council" className="flex-1 py-3 data-[state=active]:shadow-[inset_0_-2px_0_0_hsl(var(--primary))] data-[state=active]:text-primary text-slate-500 hover:text-slate-900 rounded-none bg-transparent font-medium text-sm transition-colors text-center">学生组织</TabsTrigger>
            <TabsTrigger value="merchandise" className="flex-1 py-3 data-[state=active]:shadow-[inset_0_-2px_0_0_hsl(var(--primary))] data-[state=active]:text-primary text-slate-500 hover:text-slate-900 rounded-none bg-transparent font-medium text-sm transition-colors text-center">周边文创</TabsTrigger>
            <TabsTrigger value="contact" className="flex-1 py-3 data-[state=active]:shadow-[inset_0_-2px_0_0_hsl(var(--primary))] data-[state=active]:text-primary text-slate-500 hover:text-slate-900 rounded-none bg-transparent font-medium text-sm transition-colors text-center">联系方式</TabsTrigger>
            <TabsTrigger value="changelog" className="flex-1 py-3 data-[state=active]:shadow-[inset_0_-2px_0_0_hsl(var(--primary))] data-[state=active]:text-primary text-slate-500 hover:text-slate-900 rounded-none bg-transparent font-medium text-sm transition-colors text-center">更新日志</TabsTrigger>
            <TabsTrigger value="credits" className="flex-1 py-3 data-[state=active]:shadow-[inset_0_-2px_0_0_hsl(var(--primary))] data-[state=active]:text-primary text-slate-500 hover:text-slate-900 rounded-none bg-transparent font-medium text-sm transition-colors text-center">致谢</TabsTrigger>
          </TabsList>
